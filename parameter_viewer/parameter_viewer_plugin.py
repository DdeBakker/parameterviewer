...
class BodemkwaliteitNormen:
    ...
    def __init__(self):
        ...
        self.normen = {
            'Arseen': {'Landbouw/Natuur': 20, 'Wonen': 76, 'Industrie': 76, 'Matig Verontreinigd': 85, 'Sterk Verontreinigd': 170},
            'Cadmium': {'Landbouw/Natuur': 0.6, 'Wonen': 13, 'Industrie': 13, 'Matig Verontreinigd': 16.5, 'Sterk Verontreinigd': 33},
            'Chroom': {'Landbouw/Natuur': 55, 'Wonen': 180, 'Industrie': 180, 'Matig Verontreinigd': 190, 'Sterk Verontreinigd': 380},
            'Koper': {'Landbouw/Natuur': 15, 'Wonen': 190, 'Industrie': 190, 'Matig Verontreinigd': 270, 'Sterk Verontreinigd': 540},
            'Kwik': {'Landbouw/Natuur': 0.15, 'Wonen': 36, 'Industrie': 36, 'Matig Verontreinigd': 41, 'Sterk Verontreinigd': 83},
            'Lood': {'Landbouw/Natuur': 50, 'Wonen': 530, 'Industrie': 530, 'Matig Verontreinigd': 580, 'Sterk Verontreinigd': 1160},
            'Nikkel': {'Landbouw/Natuur': 4.0, 'Wonen': 100, 'Industrie': 100, 'Matig Verontreinigd': 135, 'Sterk Verontreinigd': 270},
            'Zink': {'Landbouw/Natuur': 50, 'Wonen': 720, 'Industrie': 720, 'Matig Verontreinigd': 910, 'Sterk Verontreinigd': 1800},
            'Benzeen': {'Landbouw/Natuur': 0.01, 'Wonen': 1.1, 'Industrie': 1.1, 'Matig Verontreinigd': 15, 'Sterk Verontreinigd': 30},
            'Tolueen': {'Landbouw/Natuur': 0.01, 'Wonen': 32, 'Industrie': 32, 'Matig Verontreinigd': 516, 'Sterk Verontreinigd': 1000},
            'Ethylbenzeen': {'Landbouw/Natuur': 0.01, 'Wonen': 110, 'Industrie': 110, 'Matig Verontreinigd': 360, 'Sterk Verontreinigd': 720},
            'Xylenen': {'Landbouw/Natuur': 0.01, 'Wonen': 17, 'Industrie': 17, 'Matig Verontreinigd': 35, 'Sterk Verontreinigd': 70},
            'Naftaleen': {'Landbouw/Natuur': 0.01, 'Wonen': 5.0, 'Industrie': 5.0, 'Matig Verontreinigd': 35, 'Sterk Verontreinigd': 70},
            'Fenol': {'Landbouw/Natuur': 0.05, 'Wonen': 40, 'Industrie': 40, 'Matig Verontreinigd': 100, 'Sterk Verontreinigd': 200},
            'PAK (som 10)': {'Landbouw/Natuur': 1.5, 'Wonen': 40, 'Industrie': 40, 'Matig Verontreinigd': 50, 'Sterk Verontreinigd': 100},
            'Benzo(a)pyreen': {'Landbouw/Natuur': 0.05, 'Wonen': 1.0, 'Industrie': 1.0, 'Matig Verontreinigd': 5.5, 'Sterk Verontreinigd': 11},
            'PCB (som 7)': {'Landbouw/Natuur': 0.02, 'Wonen': 1.0, 'Industrie': 1.0, 'Matig Verontreinigd': 5.0, 'Sterk Verontreinigd': 10},
            'Tetrachlooretheen': {'Landbouw/Natuur': 0.01, 'Wonen': 19, 'Industrie': 19, 'Matig Verontreinigd': 44, 'Sterk Verontreinigd': 88},
            'Trichlooretheen': {'Landbouw/Natuur': 0.01, 'Wonen': 60, 'Industrie': 60, 'Matig Verontreinigd': 130, 'Sterk Verontreinigd': 260},
        ...
        self.interventiewaardes_t130 = {
            ...
            'Tolueen': 32, 'Xylenen (som)': 17, '4-Chloor-2-methylfenoxy-azijnzuur': 4, 'Aldrin': 320,
            'alfa-Endosulfan': 4000, 'alfa-HCH': 17000, 'Atrazine': 710, 'beta-HCH': 1600, 'Carbaryl': 0.45,
            'Carbofuran': 17, 'Chloordaan (cis + trans)': 1600, 'DDD (som)': 34000, 'DDE (som)': 2300,
            'DDT (som)': 1700, 'Drins (Aldrin+Dieldrin+Endrin)': 4000, 'gamma-HCH': 1200, 'Heptachloor': 4000,
            'Heptachloorepoxide': 4000, 'Organotin, som TBT+TFT, als SN': 2500, '1,1,1-Trichloorethaan': 15,
            '1,1,2-Trichloorethaan': 10, '1,1-Dichloorethaan': 15, '1,1-Dichlooretheen': 0.3,
            '1,2-Dichloorethaan': 6.4, 'Chloornaftaleen': 23000, 'cis + trans-1,2-Dichlooretheen': 1,
            'Dichloorbenzenen (som)': 5, 'Dichloorfenolen (som)': 22, 'Dichloormethaan': 3.9,
            'Dichloorpropaan': 2, 'Hexachloorbenzeen (HCB)': 2000, 'Monochlooranilinen (som)': 50,
            'Monochloorbenzeen': 15, 'Monochloorfenolen (som)': 5400, 'PCB (som 7)': 1000,
            'Pentachloorbenzeen (QCB)': 6700, 'Pentachloorfenol (PCP)': 12000,
            'Som 29 dioxines (als TEQ)': 180, 'Tetrachloorbenzenen (som)': 2200, 'Tetrachlooretheen (Per)': 8.8,
            'Tetrachloorfenolen (som)': 21000, 'Tetrachloormethaan (Tetra)': 0.7,
            'Tribroommethaan (bromoform)': 75, 'Trichloorbenzenen (som)': 11000, 'Trichlooretheen (Tri)': 2.5,
            'Trichloorfenolen (som)': 22000, 'Trichloormethaan (Chloroform)': 5.6, 'Vinylchloride': 0.1,
            ...
            'Benzylbutylftalaat': 48000, 'Dihexylftalaat': 220000, 'methylkwik': 4, 'som gewogen asbest': 100,
            'Bis(ethylhexyl)ftalaat': 60000, 'Cyclohexanon': 150, 'Dibutylftalaat': 36000, 'Diethylftalaat': 53000,
